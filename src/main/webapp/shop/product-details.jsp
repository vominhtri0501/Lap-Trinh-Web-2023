...
<head>
    ...
    <title>Nội thất Future | Chi Tiết Sản Phẩm</title>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="product-slider-active">
                    <div class="single-slider">
                        <img src="images/imgDetail/img.png" alt="#" />
                    </div>
                    <div class="single-slider">
                        <img src="images/imgDetail/img_1.png" alt="#" />
                    </div>
                    <div class="single-slider">
                        <img src="images/imgDetail/img_2.png" alt="#" />
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="product-content p-5">
                    <h2>Ghế Sofa Gỗ Tràm Tự Nhiên MOHO VLINE 601</h2>
                    ...
                    <h3><span>11,490,000đ</span> 7,390,000đ</h3>
                    <div class="product-peragraph">
                        <p>
                            Kích thước: Dài: 180cm x Rộng 85cm x Cao 82cm
                            Chất liệu:
